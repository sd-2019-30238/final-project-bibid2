...
<body>
 <h1>Hello</h1>
 <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for locations..">
...
%>
<tr">
<td><%=resultSet.getString("locationname") %></td>
<td>&nbsp&nbsp&nbsp&nbsp&nbsp<%=resultSet.getString("date") %>&nbsp&nbsp&nbsp&nbsp&nbsp</td>
